...
enum CupertinoDatePickerCustomMode {
...
///
/// There are several modes of the date picker listed in [CupertinoDatePickerCustomMode].
///
...
class CupertinoDatePickerCustom extends StatefulWidget {
  ...
  ///
  /// [mode] is one of the mode listed in [CupertinoDatePickerCustomMode] and defaults
  /// to [CupertinoDatePickerCustomMode.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes. When in [CupertinoDatePickerCustomMode.time] mode, the year, month and
  /// day will be the same as [initialDateTime]. When in
  /// [CupertinoDatePickerCustomMode.date] mode, this callback will always report the
  /// start time of the currently selected day. When in
  /// [CupertinoDatePickerCustomMode.monthYear] mode, the day and time will be the
  ...
  /// In [CupertinoDatePickerCustomMode.time] mode, [minimumDate] should typically be
  ...
  /// In [CupertinoDatePickerCustomMode.time] mode, [maximumDate] should typically be
  /// on the same date as [initialDateTime], as the picker will not limit the
  ...
  /// [CupertinoDatePickerCustomMode.date] mode. Defaults to 1.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [CupertinoDatePickerCustomMode.date] mode. Null if there's no limit.
  ///
  ...
  /// in [CupertinoDatePickerCustomMode.date] and [CupertinoDatePickerCustomMode.monthYear]
  ...
  CupertinoDatePickerCustom({
    super.key,
    this.mode = CupertinoDatePickerCustomMode.dateAndTime,
    ...
    assert(
      mode != CupertinoDatePickerCustomMode.dateAndTime ||
          minimumDate == null ||
    ...
    assert(
      (mode != CupertinoDatePickerCustomMode.date &&
              mode != CupertinoDatePickerCustomMode.monthYear) ||
  ...
  /// The mode of the date picker as one of [CupertinoDatePickerCustomMode]. Defaults
  /// to [CupertinoDatePickerCustomMode.dateAndTime]. Value cannot change after
  /// initial build.
  final CupertinoDatePickerCustomMode mode;
  ...
  ///
  /// In [CupertinoDatePickerCustomMode.time] mode, a time becomes unselectable if the
  ...
  /// [CupertinoDatePickerCustomMode.date] and [CupertinoDatePickerCustomMode.monthYear]
  /// mode. When using monthYear mode, both [DatePickerDateOrder.dmy] and
  /// [DatePickerDateOrder.mdy] will result in the month|year order.
  /// Defaults to the locale's default date format/order.
  ...
  State<StatefulWidget> createState() {
    ...
    return switch (mode) {
      ...
      // state.
      CupertinoDatePickerCustomMode.time => _CupertinoDatePickerDateTimeState(),
      CupertinoDatePickerCustomMode.dateAndTime =>
        _CupertinoDatePickerDateTimeState(),
      CupertinoDatePickerCustomMode.date =>
        _CupertinoDatePickerDateState(dateOrder: dateOrder),
      CupertinoDatePickerCustomMode.monthYear =>
...
class _CupertinoDatePickerDateTimeState
  ...
  int get selectedDayFromInitial {
    switch (widget.mode) {
      case CupertinoDatePickerCustomMode.dateAndTime:
        return dateController.hasClients ? dateController.selectedItem : 0;
      case CupertinoDatePickerCustomMode.time:
        return 0;
      case CupertinoDatePickerCustomMode.date:
      case CupertinoDatePickerCustomMode.monthYear:
        break;
    }
    assert(
      false,
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == CupertinoDatePickerCustomMode.dateAndTime) {
      switch (localizations.datePickerDateTimeOrder) {
        case DatePickerDateTimeOrder.time_dayPeriod_date:
        case DatePickerDateTimeOrder.dayPeriod_time_date:
      ...
      child: CupertinoPicker(
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          final String monthName =
              (widget.mode == CupertinoDatePickerCustomMode.monthYear)
